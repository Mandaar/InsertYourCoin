...
- ✅ **Lot 6 — Walk-forward** (LE JUGE) : **LIVRÉ ET GATÉ** (2026-08-08). BUG-010 (P1) et BUG-011 (P2)
  corrigés avec tests de parité stricte vs `optimizer._verdict` (commit `5db357c`) ; revue formelle
  3 lentilles (sémantique / sécurité / non-régression) : **0 P0/P1/P2, 1 P3 corrigé** (renommage de
